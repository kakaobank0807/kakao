...
public class ImagePaginationRenderer extends AbstractPaginationRenderer {
	...
	public ImagePaginationRenderer() {
		firstPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\"><image src=\"./img/leftp.png\" border=0/></a>&#160;"; 
		...
		lastPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\"><image src=\"./img/rightp.png\" border=0/></a>&#160;";
	}
}